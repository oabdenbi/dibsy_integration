<?php /* Smarty version Smarty-3.1.21, created on 2021-10-23 17:12:13
         compiled from "C:\laragon\www\cscartplugin\design\themes\responsive\templates\addons\product_reviews\views\product_reviews\components\product_reviews_navigation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10717667036174183dbfd546-25001545%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b10c3e60fe96e91c075091bcd167cfa33b481584' => 
    array (
      0 => 'C:\\laragon\\www\\cscartplugin\\design\\themes\\responsive\\templates\\addons\\product_reviews\\views\\product_reviews\\components\\product_reviews_navigation.tpl',
      1 => 1634997943,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '10717667036174183dbfd546-25001545',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6174183dcabd41_42698481',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6174183dcabd41_42698481')) {function content_6174183dcabd41_42698481($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include 'C:/laragon/www/cscartplugin/app/functions/smarty_plugins\\function.set_id.php';
?><?php
...
$_tmp3=ob_get_clean();?><?php echo htmlspecialchars(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp3."&selected_section=product_reviews"), ENT_QUOTES, 'UTF-8');?>
"
    ...
    <nav class="ty-product-review-reviews-navigation">
        ...
        <label class="ty-product-review-reviews-navigation__filter <?php if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?>ty-product-review-reviews-navigation__filter--active<?php }?>">
            ...
            <a id="product_review_with_images_link"
                href="<?php ob_start();
if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?><?php echo "0";?><?php } else { ?><?php echo "1";?><?php }
$_tmp4=ob_get_clean();?><?php echo htmlspecialchars(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp4."&selected_section=product_reviews"), ENT_QUOTES, 'UTF-8');?>
"
                class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                data-ca-target-id="pagination_contents_comments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_id']->value, ENT_QUOTES, 'UTF-8');?>
"
